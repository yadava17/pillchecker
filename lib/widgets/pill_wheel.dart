            ...
            builder: (context, index) {
              ...
              if (index == 0) {
                final plusCircle = Container(
                  ...
                  child: const Center(
                    child: Icon(Icons.add, size: 34, color: Color(0xFF98404F)),
                  ),
                );
              ...
              Widget circleCore = Stack(
                ...
                children: [
                  ...
                  AnimatedOpacity(
                    duration: const Duration(milliseconds: 260), // longer fade
              ...
              // ✅ Hold-to-delete gestures only for REAL pills
              if (isRealPill) {
                circleCore = GestureDetector(
                  behavior: HitTestBehavior.opaque,
                  onTapDown: (_) =>
                      _startHoldToDelete(index, isCentered: isCentered),
